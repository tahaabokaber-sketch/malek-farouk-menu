      ...
      <main id="top">
          ...
          <div className="container hero-grid">
            <div className="hero-copy">
              ...
              <div className="hero-actions">
                ...
                <a href="https://www.facebook.com/61560923634183/posts/%D9%85%D9%86%D9%8A%D9%80%D9%88-%D9%85%D8%B7%D8%B9%D9%85-%D8%A7%D9%84%D9%85%D9%80%D9%84%D9%83-%D9%81%D9%80%D8%A7%D8%B1%D9%88%D9%82/122184870386364121/" target="_blank" rel="noreferrer" className="secondary-button">البوست الأصلي <ExternalLink size={16} /></a>
              </div>
              <div className="hero-meta">
                <div><MapPin size={17} /><span>سوهاج — شارع البحر</span></div>
                <div><Phone size={17} /><span>01070633307</span></div>
              </div>
            </div>
        ...
        <section className="menu-section" id="menu">
          <div className="container">
            ...
            <div className="gallery-note"><span>المعروض هنا هو الصور التي تم استخراجها من منشور المنيو.</span><a href="https://www.facebook.com/61560923634183/posts/%D9%85%D9%86%D9%8A%D9%80%D9%88-%D9%85%D8%B7%D8%B9%D9%85-%D8%A7%D9%84%D9%85%D9%80%D9%84%D9%83-%D9%81%D9%80%D8%A7%D8%B1%D9%88%D9%82/122184870386364121/" target="_blank" rel="noreferrer">عرض المنشور الأصلي <ExternalLink size={14} /></a></div>
          </div>
        </section>

        <section className="about-section" id="about">
          <div className="container about-grid">
            <div className="about-card"><span className="quote-mark">“</span><h2>الأكل الحلو<br /><em>يلم العيلة.</em></h2><p>من أول الفطار لحد قعدة العشا، بنحضر أكلنا بحب ونقدمه في أجواء هادية على كورنيش النيل.</p><a href="tel:01070633307">احجز ترابيزتك <ArrowLeft size={17} /></a></div>
            <div className="about-details"><div className="eyebrow eyebrow-dark"><span /> في انتظارك <span /></div><h2>تعالى جرّب<br /><em>طعم الملك.</em></h2><div className="detail-list"><div><span className="detail-icon"><MapPin size={18} /></span><div><strong>العنوان</strong><p>سوهاج، شارع البحر، داخل فندق الفنار أزور</p></div></div><div><span className="detail-icon"><Phone size={18} /></span><div><strong>للحجز والاستفسار</strong><p>01070633307 — متاحين يوميًا</p></div></div></div></div>
          </div>
        </section>
      </main>

      <footer className="site-footer" id="contact"><div className="container footer-inner"><div className="brand footer-brand"><span className="brand-mark">م</span><span><strong>الملك فاروق</strong><small>مطعم وكافيه</small></span></div><p>طعم أصيل بجو على النيل</p><div className="footer-links"><a href="tel:01070633307">01070633307</a><a href="https://www.facebook.com/61560923634183" target="_blank" rel="noreferrer">فيسبوك</a></div></div></footer>
